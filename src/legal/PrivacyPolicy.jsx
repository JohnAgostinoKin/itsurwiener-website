    ...
    <div className="bg-[#04030A] min-h-screen px-[5vw] py-32 max-w-[860px] mx-auto">
      ...
      <motion.div {...inView(0.1)} className="prose prose-invert max-w-none">
        {[
          ...
          { h: 'Payment Information', p: 'All payment transactions are processed through Stripe and Stripe. We do not store your full credit card information on our servers. Please review their privacy policies for more information.' },
