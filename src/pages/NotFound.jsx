...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-[5vw]">
      ...
      <Link to="/" className="font-ui text-[12px] font-bold tracking-[.18em] uppercase bg-orange text-black px-8 py-4 no-underline clip-angled hover:bg-white transition-colors">Back to the Complex</Link>
    </div>
  )
}
