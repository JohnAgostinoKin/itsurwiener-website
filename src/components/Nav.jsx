  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-[800] flex items-center justify-between px-[5vw] h-[72px] transition-all duration-300 ${scrolled ? 'bg-[rgba(4,3,10,0.95)] backdrop-blur-lg border-b border-orange/10' : ''}`}>
        ...
        <Link to="/events" className="hidden lg:block font-ui text-[11px] font-bold tracking-[.18em] uppercase bg-orange text-black px-6 py-3 no-underline clip-angled-sm hover:bg-white transition-colors duration-200">
          Book an Event
        </Link>
